...
var console = function(o) {
    var n = location.hostname.startsWith("localhost");
    return {
        log: function(t) {
            n && o.log(t)
        },
...
Date.prototype.formatToDateBr = function() {
    return this.getDate().toString().padStart(2, "0") + "/" + (this.getMonth() + 1).toString().padStart(2, "0") + "/" + this.getFullYear()
}
,
Date.prototype.formatToDateTimeBr = function() {
    return this.getDate().toString().padStart(2, "0") + "/" + (this.getMonth() + 1).toString().padStart(2, "0") + "/" + this.getFullYear() + " " + this.toTimeString().substr(0, 8)
}
,
Date.prototype.formatToDateEn = function() {
...
!function(e, t) {
    ...
    var h = function(n) {
        var e, p, x, o, i, h, f, g, w, u, l, C, T, a, E, v, s, c, y, N = "sizzle" + 1 * new Date, m = n.document, A = 0, r = 0, d = ue(), b = ue(), S = ue(), k = ue(), D = function(e, t) {
            return e === t && (l = !0),
            0
            ...
            for (var n = 0, r = e.length; n < r; n++)
                if (e[n] === t)
                    return n;
            return -1
        }, I = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", R = "[\\x20\\t\\r\\n\\f]", B = "(?:\\\\.|[\\w-]|[^\0-\\xa0])+", M = "\\[" + R + "*(" + B + ")(?:" + R + "*([*^$|!~]?=)" + R + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + B + "))|)" + R + "*\\]", W = ":(" + B + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + M + ")*)|.*)\\)|)", $ = new RegExp(R + "+","g"), _ = new RegExp("^" + R + "+|((?:^|[^\\\\])(?:\\\\.)*)" + R + "+$","g"), F = new RegExp("^" + R + "*," + R + "*"), z = new RegExp("^" + R + "*([>+~]|" + R + ")" + R + "*"), U = new RegExp(R + "|>"), V = new RegExp(W), X = new RegExp("^" + B + "$"), Q = {
            ID: new RegExp("^#(" + B + ")"),
            CLASS: new RegExp("^\\.(" + B + ")"),
            TAG: new RegExp("^(" + B + "|[*])"),
            ATTR: new RegExp("^" + M),
        ...
        function se(e, t, n, r) {
            ...
            "string" != typeof e || !e || 1 !== d && 9 !== d && 11 !== d)
                return n;
            if (!r && ((t ? t.ownerDocument || t : m) !== T && C(t),
            t = t || T,
            E)) {
                if (11 !== d && (u = Z.exec(e)))
                    if (i = u[1]) {
                ...
                if (p.qsa && !k[e + " "] && (!v || !v.test(e)) && (1 !== d || "object" !== t.nodeName.toLowerCase())) {
                    if (c = e,
                    f = t,
                    1 === d && U.test(e)) {
                        for ((s = t.getAttribute("id")) ? s = s.replace(re, ie) : t.setAttribute("id", s = N),
                        o = (l = h(e)).length; o--; )
                            l[o] = "#" + s + " " + be(l[o]);
                        c = l.join(","),
                ...
                CHILD: function(h, e, t, g, v) {
                    ...
                    : function(e, t, n) {
                        ...
                        if (c) {
                            ...
                            m && d) {
                                for (p = (s = (r = (i = (o = (a = c)[N] || (a[N] = {}))[a.uniqueID] || (o[a.uniqueID] = {}))[h] || [])[0] === A && r[1]) && r[2],
                            ...
                            !1 === p)
                                for (; (a = ++s && a && a[l] || (p = s = 0) || u.pop()) && ((b ? a.nodeName.toLowerCase() !== f : 1 !== a.nodeType) || !++p || (d && ((i = (o = a[N] || (a[N] = {}))[a.uniqueID] || (o[a.uniqueID] = {}))[h] = [A, p]),
                                a !== e)); )
                                    ;
                ...
                if (t = x.relative[e[s].type])
                    ...
                    if ((t = x.filter[e[s].type].apply(null, e[s].matches))[N]) {
                        ...
                        return Te(1 < s && we(c), 1 < s && be(e.slice(0, s - 1).concat({
                            value: " " === e[s - 2].type ? "*" : ""
                        })).replace(_, "$1"), t, s < n && Ee(e.slice(s, n)), n < r && Ee(e = e.slice(n)), n < r && be(e))
                    }
                    c.push(t)
                }
            return we(c)
    ...
    E.fn.extend({
        ...
        is: function(e) {
            return !!L(this, "string" == typeof e && S.test(e) ? E(e) : e || [], !1).length
        }
    });
    var j, q = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
    ...
    E.ready.then = $.then,
    "complete" === v.readyState || "loading" !== v.readyState && !v.documentElement.doScroll ? g.setTimeout(E.ready) : (v.addEventListener("DOMContentLoaded", _),
    ...
    E.event = {
        ...
        special: {
            ...
            click: {
                setup: function(e) {
                    var t = this || e;
                    return fe.test(t.type) && t.click && k(t, "input") && ke(t, "click", Ee),
                    !1
                },
                trigger: function(e) {
                    var t = this || e;
                    return fe.test(t.type) && t.click && k(t, "input") && ke(t, "click"),
                    !0
                },
                _default: function(e) {
                    var t = e.target;
                    return fe.test(t.type) && t.click && k(t, "input") && G.get(t, "click") || k(t, "a")
                }
            },
            beforeunload: {
    ...
    var ze = ["Webkit", "Moz", "ms"]
      ...
      , Ve = {};
    function Xe(e) {
        return E.cssProps[e] || Ve[e] || (e in Ue ? e : Ve[e] = function(e) {
    ...
    E.cssHooks.marginLeft = Fe(b.reliableMarginLeft, function(e, t) {
        if (t)
    ...
    E.extend({
        attr: function(e, t, n) {
            ...
            if (3 !== o && 8 !== o && 2 !== o)
                return void 0 === e.getAttribute ? E.prop(e, t, n) : (1 === o && E.isXMLDoc(e) || (i = E.attrHooks[t.toLowerCase()] || (E.expr.match.bool.test(t) ? rt : void 0)),
    ...
    E.extend(E.event, {
        trigger: function(e, t, n, r) {
            ...
            h.sort()),
            u = p.indexOf(":") < 0 && "on" + p,
            (e = e[E.expando] ? e : new E.Event(p,"object" == _typeof(e) && e)).isTrigger = r ? 2 : 3,
            e.namespace = h.join("."),
    ...
    E.each(["top", "left"], function(e, n) {
        E.cssHooks[n] = Fe(b.pixelPosition, function(e, t) {
            if (t)
                return t = _e(e, n),
...
!function(s) {
    var i = function t(e, o) {
        this.$element = s(e),
        this.options = s.extend({}, t.DEFAULTS, o),
        this.isLoading = !1
    };
    function o(n) {
        return this.each(function() {
            ...
            e || t.data("bs.button", e = new i(this,o)),
    ...
    i.prototype.setState = function(t) {
        var e = "disabled"
          ...
          , i = o.data();
        t += "Text",
        null == i.resetText && o.data("resetText", o[n]()),
        setTimeout(s.proxy(function() {
            o[n](null == i[t] ? this.options[t] : i[t]),
            "loadingText" == t ? (this.isLoading = !0,
            o.addClass(e).attr(e, e).prop(e, !0)) : this.isLoading && (this.isLoading = !1,
            o.removeClass(e).removeAttr(e).prop(e, !1))
        }, this), 0)
    }
    ,
...
!function(o) {
    var l = function t(e, n) {
        this.$element = o(e),
        this.options = o.extend({}, t.DEFAULTS, n),
    ...
    function r(a) {
        return this.each(function() {
            var t = o(this)
              ...
              , n = o.extend({}, l.DEFAULTS, t.data(), "object" == _typeof(a) && a);
        ...
        if (!this.transitioning && !this.$element.hasClass("in")) {
            ...
            if (!(e && e.length && (t = e.data("bs.collapse")) && t.transitioning)) {
                ...
                !n.isDefaultPrevented()) {
                    ...
                    if (!o.support.transition)
                        return s.call(this);
                    var i = o.camelCase(["scroll", a].join("-"));
                    this.$element.one("bsTransitionEnd", o.proxy(s, this)).emulateTransitionEnd(l.TRANSITION_DURATION)[a](this.$element[0][i])
                }
            }
        }
    }
    ...
    var t = o.fn.collapse;
    o.fn.collapse = r,
    o.fn.collapse.Constructor = l,
    o.fn.collapse.noConflict = function() {
        return o.fn.collapse = t,
        this
    }
    ,
    o(document).on("click.bs.collapse.data-api", '[data-toggle="collapse"]', function(t) {
        ...
        var n = s(e)
          , a = n.data("bs.collapse") ? "toggle" : e.data();
        r.call(n, a)
    })
}(jQuery);
"use strict";
!function(d) {
    ...
    function s(t) {
        ...
        var n = "#" !== e ? d(document).find(e) : null;
        return n && n.length ? n : t.parent()
    }
    function a(o) {
        o && 3 === o.which || (d(".dropdown-backdrop").remove(),
        d(i).each(function() {
            var t = d(this)
              , e = s(t)
              , n = {
            ...
            e.hasClass("open") && (o && "click" == o.type && /input|textarea/i.test(o.target.tagName) && d.contains(e[0], o.target) || (e.trigger(o = d.Event("hide.bs.dropdown", n)),
            o.isDefaultPrevented() || (t.attr("aria-expanded", "false"),
            e.removeClass("open").trigger(d.Event("hidden.bs.dropdown", n)))))
        }))
    }
    o.VERSION = "3.4.1",
    o.prototype.toggle = function(t) {
        ...
        if (!e.is(".disabled, :disabled")) {
            ...
            if (a(),
            !o) {
                "ontouchstart"in document.documentElement && !n.closest(".navbar-nav").length && d(document.createElement("div")).addClass("dropdown-backdrop").insertAfter(d(this)).on("click", a);
                var r = {
                    relatedTarget: this
                };
                if (n.trigger(t = d.Event("show.bs.dropdown", r)),
                t.isDefaultPrevented())
                    return;
                e.trigger("focus").attr("aria-expanded", "true"),
                n.toggleClass("open").trigger(d.Event("shown.bs.dropdown", r))
            }
            return !1
        }
    }
        ...
        if (/(38|40|27|32)/.test(t.which) && !/input|textarea/i.test(t.target.tagName)) {
            ...
            !e.is(".disabled, :disabled")) {
                ...
                if (!o && 27 != t.which || o && 27 == t.which)
                    return 27 == t.which && n.find(i).trigger("focus"),
                    e.trigger("click");
    ...
    ,
    d.fn.dropdown.Constructor = o,
    d.fn.dropdown.noConflict = function() {
        return d.fn.dropdown = t,
        this
    }
    ,
    d(document).on("click.bs.dropdown.data-api", a).on("click.bs.dropdown.data-api", ".dropdown form", function(t) {
        t.stopPropagation()
...
"use strict";
navigator.serviceWorker && navigator.serviceWorker.register("".concat(window.location.origin, "/service-worker.js")).then(function(e) {
    console.log("Excellent, registered with scope: ", e.scope)
}, function(e) {
...
$(document).ready(function() {
    $('select[class~="filter-uf"]').on("change", function(o) {
        "" != o.target.value && window.location.assign("/resultado-do-jogo-do-bicho/".concat(o.target.value))
    }),
